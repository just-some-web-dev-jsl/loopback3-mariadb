...
const originImageFileName = 'test-bug-avatar-rotate';
const mimeType = 'jpg';
const originImageFilePath = path.resolve(__dirname, `${originImageFileName}.${mimeType}`);

const options = {
  inputFilePath: originImageFilePath,
  outputFileName: `${originImageFileName}.${mimeType}`,
  mimeType: mimeType,
  outputSize: [null, null], // array [width, height] or array in array [[width, height]]
  cropped: 0,
  squared: 1,
};
